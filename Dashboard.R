  ...
  tabPanel("Data Story",
           fluidRow(
             column(8, offset = 2,
                    ...
                    p("To answer this, we analyzed over 160,000 tracks from Spotify's database, spanning from the roaring 1920s to the viral hits of 2020. Our findings show that the qualities of top songs are far from stale, reflecting our cultural trends."),
